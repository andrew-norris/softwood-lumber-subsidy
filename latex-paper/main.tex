...
\begin{figure}[H]
  ...
  \caption{Agriculture, Forestry, Fishing and Hunting as Percentage of Total GDP (1997--2024)}
  \label{fig:forestry_gdp}
  % \footnotesize Source: \citet{statcan2025gdp}, Table 36-10-0434-03.
\end{figure}
...
While these rates varied slightly from 2017 to 2025, they have spiked upwards this year with the re-election of Donald Trump [TODO]. It is hard to assess the full impact of these tariffs, but with the anti-dumping rates almost tripling this year [TODO], they must be considered when looking forward in the softwood lumber industry.
...
Construction firms can often substitute between concrete, steel, and lumber for different projects depending on prices [TODO]. And while there was a large spike in lumber prices around covid 2019 [TODO], it's price is now closely comparable to ready mix concrete when indexed from 2010 prices [TODO]. This gives the government the opportunity to make lumber a more appealing material for construction by lowering its real price to be in line with steel and concrete.
...
Tariff rates are calculated based on the dates of actions taken as part of the Annual Reviews (AR) 1 through 6 [TODO]. Constant weights were used for this paper based on 2023 export quantities [TODO]. After AR3, resolute was not given individual tariff rates [TODO]. After AR5 J.D. Irving was not given individual tariff rates [TODO].
