...
\hline
\noalign{\vskip 0.4em}
$L$ & $1/3$ & Time spent working \\
$i^*$ & $1.97\%$ & Real net interest rate \\
$\delta$ & $0.0348$ & Depreciation rate \\
$\alpha$ & $0.653$ & Capital share of income\\
\hline
\end{tabular}
\caption{Sources: \citet{pwt2025}. \citet{ceic2025interest_rates}. Notes: $L$ chosen by author. $\alpha$ calculations defined in Appendix~\ref{app:capital_share}}
\end{table}
